...
public class GameDesign : EditorWindow
{
    ...
    void OnEnable()
    {
        ...
        vars = (managerVars)AssetDatabase.LoadAssetAtPath("Assets/ShooterRage/Resources/managerVarsContainer.asset", typeof(managerVars));
